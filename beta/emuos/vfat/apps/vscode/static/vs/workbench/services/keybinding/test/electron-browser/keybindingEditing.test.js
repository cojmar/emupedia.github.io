    ...
    suite('KeybindingsEditing', () => {
        ...
        setup(() => {
            return setUpWorkspace().then(() => {
                ...
                instantiationService.stub(untitledTextEditorService_1.IUntitledTextEditorService, instantiationService.createInstance(untitledTextEditorService_1.UntitledTextEditorService));
