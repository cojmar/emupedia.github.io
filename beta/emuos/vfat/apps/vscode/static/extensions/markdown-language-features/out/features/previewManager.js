...
class MarkdownPreviewManager extends dispose_1.Disposable {
    ...
    async resolveWebviewEditor(input, webview) {
        const preview = preview_1.DynamicMarkdownPreview.revive({ resource: input.resource, locked: false, resourceColumn: vscode.ViewColumn.One }, webview, this._contentProvider, this._previewConfigurations, this._logger, this._topmostLineMonitor, this._contributions);
