...
class TypeScriptServerError extends Error {
    ...
    static create(serverId, version, response) {
        ...
        return new TypeScriptServerError(serverId, version, response, (_a = parsedResult) === null || _a === void 0 ? void 0 : _a.message, (_b = parsedResult) === null || _b === void 0 ? void 0 : _b.stack);
    }
